...
const ArticlePreview: Component<{ preview: string, replyingTo?: string, replyingToPreview?: string, author: string, keyChecksum: string, hash: string, timestamp: number, participating: number, i: number }> = (props) => {
    ...
    return (
        <article onClick={onClick} class={style.post} style={`--i: ${props.i};`}>
            <div class={style.content}>
                ...
                <Author timestamp={props.timestamp} author={props.author} keyChecksum={props.keyChecksum} participating={props.participating} class="" />
